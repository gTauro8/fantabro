...
export const players: Player[] = [
  ...
  p('Zion Suzuki', 'Parma', 'POR', 'Scommessa', 'Alto volume di parate, ideale per Modificatore Difesa.', 'Medio'),
  ...
  p('Christian Pulisic', 'Milan', 'CEN', 'Top', 'Riferimento offensivo del Milan di Amorim.', 'Basso'),
  ...
  p('Mateo Pellegrino', 'Parma', 'ATT', 'Low-cost', 'Riferimento offensivo low-cost del Parma.', 'Basso'),
