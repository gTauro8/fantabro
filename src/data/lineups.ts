...
export const lineups: Lineup[] = [
  ...
  },
  {
    ...
    formation: '3-4-2-1',
    goalkeeper: 'Okoye',
    defenders: ['Zanoli', 'Kabasele', 'Solet'],
    midfielders: ['Vojvoda', 'Karlström', 'Miller', 'Kamara'],
    attackingMid: ['Zaniolo', 'Ekkelenkamp'],
    forwards: ['Keinan Davis'],
    battles: "Ekkelenkamp/Unai Gómez/Chakvetadze (trequarti). Kristensen ceduto all'Atalanta (12-13/08): Zanoli, ex Napoli, eredita la maglia da titolare.",
    bench: {
      goalkeepers: ['Padelli'],
  ...
  },
  {
    ...
    forwards: ['Touré', 'Almqvist'],
    battles: "Delprato-Troilo, Almqvist/Ondrejka/Diallo/Zouin. Suzuki verso il PSG e Pellegrino ceduto alla Fiorentina (~30M): il Parma tratta l'attaccante David Romero (El Tigre, ~9M), non ancora chiuso.",
    bench: {
      goalkeepers: ['Daffara'],
      defenders: ['Carboni', "Ndiaye"],
      midfielders: ['Nicolussi Caviglia', 'Cremaschi'],
      forwards: ['Ondrejka', 'Benedyczak', 'Diallo', 'Zouin'],
    },
  },
  {
    team: 'cagliari',
  ...
  },
  {
    ...
    midfielders: ['Birindelli', 'Akinsanmiro', 'Mangas'],
    attackingMid: ['Colpani', 'Mota'],
    forwards: ['Cutrone'],
    battles: "Lucchesi/Delli Carri, Mota/Robinson/Ciurria, Cutrone/Petagna. Pessina si opera al ginocchio il 14/8 (out 2-3 mesi): il club non interviene sul mercato, il vuoto in mediana resta da coprire con la rosa attuale.",
    bench: {
